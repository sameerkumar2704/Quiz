...
function init() {
  ...
  const show_password_sign_up = document.getElementById(
    "show-password-sign-up"
  );
  const sign_up_password = document.getElementById("sign-up-password");
  const sign_up_conform_password = document.getElementById(
    "sign-up-conform-password"
  );
  const show_conform_password_sing_up = document.getElementById(
    "show-conform-password"
  );
  ...
  sign_up_form.addEventListener("submit", (e) => {
    ...
    try {
      ...
      validatePassword(passowrd, conform_password, true);
      createNewUser(user_name, passowrd);
      ReplaceUrl("test/test.html");
    } catch (e) {
